  ...
  return (
    <section className="relative pt-36 pb-20 bg-[#1B3A5C] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          News & <span className="text-[#C8860A]">Insights</span>
        </motion.h1>
        <p className="text-gray-300 max-w-2xl mx-auto text-lg">
          Stay up-to-date with current construction trends, home renovation guides, and structural project announcements.
        </p>
      </div>
    </section>
  );
