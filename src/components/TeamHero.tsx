  ...
  return (
    <section className="relative pt-36 pb-20 bg-[#1B3A5C] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          Our Expert <span className="text-[#C8860A]">Team</span>
        </motion.h1>
        <p className="text-gray-300 max-w-2xl mx-auto text-lg">
          Meet the dedicated architects, engineers, designers, and project managers behind Naheed & Sons' landmark structures.
        </p>
      </div>
    </section>
  );
